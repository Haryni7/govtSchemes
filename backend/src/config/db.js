...
//     const mappedSchemes = schemesData.map((item) => ({
//       scheme: item.Scheme,
...
//     // Insert schemes
//     await Scheme.insertMany(mappedSchemes, { ordered: false });
//     console.log(`Inserted ${mappedSchemes.length} schemes successfully`);
//   } catch (error) {
//     console.error("Failed to insert schemes:", error);
//     if (error.code === 11000) {
//       console.log("Some schemes were skipped due to duplicate names.");
//     }
//   } finally {
